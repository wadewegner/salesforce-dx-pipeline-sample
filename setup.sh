...
DEV_HUB_USERNAME="drivard@esdx.com"
DEV_USERNAME="test-emmybuywrjob@example.com"
STAGING_USERNAME="test-6zne1icwqsf0@example.com"
PROD_USERNAME="test-hhhwsspw2hod@example.com"

# Repository with your code
GITHUB_REPO="donaldrivard/salesforce-dx-pipeline-sample"

# Your package name
PACKAGE_NAME="PipelineTest"
